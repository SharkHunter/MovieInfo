...
public class ALLOCINEPlugin implements Plugin
{
	...
	{
		fs = sb.indexOf("<h2 class=\"SpBlocTitle\" >Synopsis</h2>");
		if (fs > -1)
...
//			System.out.println(this.getClass().getSimpleName() + " " + plot);
	...
	{
		return "allocine.fr/film";
	}
	public String getVideoURL()
	{
		return "http://www.allocine.fr/film###MOVIEID###";
	}
	public String lookForMovieID(BufferedReader in) {
		try {
			...
			int fs = temp.indexOf("http://www.allocine.fr/film/fichefilm_gen_cfilm");
			int end = temp.indexOf("\"", fs+27);
			newURL = null;
			if (fs > -1) {
